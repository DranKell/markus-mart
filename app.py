...
def init_db():
    with app.app_context():
        ...
        if count == 0:
            demo = [
                ("Рюкзак туристический 65L", "Прочный рюкзак с водоотталкивающим покрытием, системой вентиляции спины и множеством карманов. Идеален для многодневных походов. Объём 65 литров, вес 1.8 кг, материал — ripstop nylon 420D.", 5490.0, 12, None, None, None),
                ("Палатка 3-местная 'Эверест Pro'", "Всесезонная палатка с двойным тентом, усиленными колышками и ветроустойчивой конструкцией. Вес 2.8 кг, водостойкость 3000 мм.", 12990.0, 5, None, None, None),
                ("Спальник -15°C 'Арктика'", "Тёплый спальный мешок для зимних походов. Утеплитель Hollow Fiber, компрессионный мешок в комплекте. Температура комфорта -5°C, экстрим -15°C.", 4890.0, 0, None, None, None),
                ("Фонарь кемпинговый LED 500лм", "Мощный светодиодный фонарь с плавной регулировкой яркости, powerbank-функцией и защитой IPX6. Работает до 12 часов. Аккумулятор 10000 mAh.", 2490.0, 20, None, None, None),
                ("Компас жидкостный 'Турист Pro'", "Точный туристический компас с линейкой, увеличительным стеклом и светящейся шкалой. Ударопрочный корпус ABS. Диаметр 55 мм.", 1490.0, 50, None, None, None),
                ("Горелка газовая 'Следопыт'", "Компактная газовая горелка мощностью 2800 Вт. Складная конструкция, пьезоподжиг, работает при ветре до 5 м/с. Расход газа 140 г/час.", 1890.0, 8, None, None, None),
            ]
            db.executemany(
            ...
            db.commit()
            print("[INIT] Тестовые товары добавлены:", len(demo))
